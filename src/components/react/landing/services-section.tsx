...
import {
    Shield, Bug, GraduationCap, HardDrive, Search, Check, ArrowRight, Clock, ChevronDown, ChevronUp, Layers
} from "lucide-react";
...
interface ServiceItem {
    ...
    addons:      ReadonlyArray<{ name: string
        desc:                          string }>
    cta:         string
    cta_link?:   string
    popular:     boolean
                        ...
                        >
                            <div className="pt-4 mt-4 border-t border-slate-200">
                                ...
                                <a
                                    ...
                                    `}
                                    href={!service.comingSoon ? (service.cta_link ?? `#`) : `#`}
...
export function ServicesSection({
    ...
    const filteredServices = useMemo(() => t.items, [ t.items ]);
